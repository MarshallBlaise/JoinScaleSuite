...
import { Check, LineChart, Users, Wallet, Sparkles, Shield, Calculator } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Input } from "@/components/ui/input";
import { Slider } from "@/components/ui/slider";

export default function ClippersLandingClean() {
  ...
  const JOIN_URL =
    "https://docs.google.com/forms/d/e/1FAIpQLSfh0OryKYow6OqtLM5M4VOmLD9EgeSMHl27vUScEC-Tmn1lLw/viewform?usp=header";
  ...
  const steps = [
    { title: "Join", desc: "Enter the free community and complete a short profile." },
  ...
  return (
    <div className="min-h-screen bg-white text-gray-900">
        ...
        <div className="mx-auto max-w-7xl px-6 pt-16 pb-10">
          <div className="grid lg:grid-cols-2 gap-10 items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="relative z-10">
              ...
              <p className="mt-4 text-lg text-gray-950 max-w-prose">
              ...
              <div className="mt-4">
                <a
                  href="https://www.tiktok.com/@wcontentclip/video/7405357019592494366"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center text-sm font-medium underline hover:no-underline"
                >
                  Neon spends $130,000 per month on clippers — watch the video
                </a>
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.1 }} className="relative">
              <div className="pointer-events-none absolute -inset-3 -z-10 rounded-3xl bg-gradient-to-r from-blue-400/25 via-sky-400/20 to-indigo-400/25 blur-2xl" />
              <Card className="rounded-2xl bg-white/95 border border-blue-100 shadow-2xl ring-1 ring-blue-200">
                <CardHeader>
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <div className="mt-2 flex items-center gap-3">
                      ...
                      />
                      <span className="text-sm text-gray-700">per clip</span>
                    </div>
                    <div className="mt-3 [&>[role=slider]]:h-5 [&>[role=slider]]:w-5">
                  ...
                  <div>
                    ...
                    <div className="mt-3 [&>[role=slider]]:h-5 [&>[role=slider]]:w-5">
                      <Slider value={[rate]} min={0.5} max={3} step={0.05} onValueChange={(v) => setRate(v[0])} />
                    </div>
                  </div>

                  <div className="rounded-xl bg-blue-50 p-4 ring-1 ring-blue-200">
                    <p className="text-sm text-gray-700">Estimated payout</p>
                    <p className="mt-1 text-3xl font-semibold">${earnings}</p>
                    <p className="mt-1 text-xs text-gray-600">Based on {views.toLocaleString()} views at ${rate.toFixed(2)} CPM</p>
                  </div>
      ...
      <section className="mx-auto max-w-7xl px-6 py-14">
        <div className="grid lg:grid-cols-2 gap-10 items-start">
          <div>
            ...
            <p className="mt-3 text-gray-900 max-w-prose">Focused on experienced clippers. We keep training optional and standards mandatory so every delivery is consistent and fair.</p>
              ...
              {steps.map((s, i) => (
                <div key={i} className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-800">{s.desc}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <Card className="rounded-2xl">
            ...
            <CardContent>
              ...
              {/* Secondary placement of proof link under payouts */}
              <div className="mt-3 text-sm">
                ...
                >
                  Proof of demand: Neon pays $130,000/month to clippers (video)
                </a>
              </div>
            </CardContent>
          </Card>
      ...
      {/* Standards (tabs removed) */}
      <section className="mx-auto max-w-7xl px-6 py-14">
        <div className="grid lg:grid-cols-2 gap-10 items-center">
          <div>
            <h2 className="text-3xl font-semibold">Standards that make work easy</h2>
            <p className="mt-3 text-gray-900 max-w-prose">We keep training optional and focus on a short ruleset so your edits pass quickly. Style guide, safe zones, captions, and export specs are provided. QC is fast and fair.</p>
            {/* The two tabs (View standards / Preview export specs) have been intentionally removed per request. */}
          </div>
          <Card className="rounded-2xl">
            <CardHeader>
          ...
          <div>
            ...
            <div className="mt-6 space-y-6">
              <div>
                ...
                <p className="text-sm text-gray-800">Yes. There are no fees to join or apply. You only need to follow the standards on paying jobs.</p>
              </div>
              <div>
                <h3 className="font-medium">How do payouts work</h3>
                <p className="text-sm text-gray-800">We pay based on verified views during the agreed window. There is a minimum per approved clip, plus bonuses for retention and fast delivery. Rates vary by tier from $0.50 to $2.00 per 1,000 views.</p>
              </div>
              <div>
                <h3 className="font-medium">Do I have to take training</h3>
                <p className="text-sm text-gray-800">Training is optional. We focus on a short and clear standards checklist. If you want, there are quick refreshers for hooks, pacing, and captions.</p>
              </div>
              <div>
                <h3 className="font-medium">Do I need experience with clipping</h3>
                <p className="text-sm text-gray-800">No. We provide courses that teach you how to submit approved work, so you can get started even without prior experience.</p>
              </div>
            </div>
          </div>
          <Card className="rounded-2xl">
            ...
            <CardContent>
              <p className="text-sm text-gray-800">Join now and get matched to creators. Bring your style and speed. We bring briefs, structure, and payouts.</p>
              <div className="mt-4 flex gap-3">
                {/* Replaced "Apply now" with "Join" and linked to Google Form */}
                <Button className="rounded-2xl px-6" asChild>
                  <a href={JOIN_URL} target="_blank" rel="noopener noreferrer">Join</a>
                </Button>
              </div>
            </CardContent>
          </Card>
      ...
      <footer className="border-t py-8 text-center text-sm text-gray-700">
